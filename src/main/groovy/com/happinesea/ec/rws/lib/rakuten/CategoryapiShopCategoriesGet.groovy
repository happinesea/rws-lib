 ...
 *
 */
class CategoryapiShopCategoriesGet<RwsBaseForm, RwsCategorysetsGetResponseResult> extends AbstractApiProxy {
	...
	Class<RwsCategorysetsGetResponseResult> clz = RwsCategorysetsGetResponseResult
	return crawler.getApiContents(parameter, rwsResponseParser, clz);
    }
}
